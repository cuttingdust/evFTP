...
/* @@protoc_insertion_point(class_definition:XMsg.XLoginRes) */ {
 public:
  ...
  XLoginRes* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
 ...
 protected:
  ...
  XLoginRes(::google::protobuf::Arena* arena, XLoginRes&& from) noexcept
      : XLoginRes(arena) {
    *this = ::std::move(from);
  }
  const ::google::protobuf::Message::ClassData* GetClassData() const PROTOBUF_FINAL;
...
/* @@protoc_insertion_point(class_definition:XMsg.XLoginReq) */ {
 public:
  ...
  XLoginReq* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
 ...
 protected:
  ...
  XLoginReq(::google::protobuf::Arena* arena, XLoginReq&& from) noexcept
      : XLoginReq(arena) {
    *this = ::std::move(from);
  }
  const ::google::protobuf::Message::ClassData* GetClassData() const PROTOBUF_FINAL;
